...
export const treeSeedsProducts = [];
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-8 pt-4">
                    ...
                    <p className="text-sm text-gray-600">
                        Explore seeds for growing various trees, including fruit, ornamental, and forestry species.
                    </p>
                ...
                <div className="flex flex-col items-center justify-center py-20 px-6 bg-white border border-gray-200 rounded-lg text-center">
                    ...
                    <p className="text-gray-500 mt-2">
                        Our collection of tree and forestry seeds is currently being curated. Please check back soon!
                    </p>
                    <Link
                        to="/shop" // Link back to the main shop page or home
