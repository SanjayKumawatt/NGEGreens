...
export const shrubSeedsProducts = [];

const ShrubSeedsPage = () => {
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-8 pt-4">
                    ...
                    <p className="text-sm text-gray-600">
                        Grow versatile and beautiful shrubs that add structure, color, and texture to your garden beds and borders.
                    </p>
                ...
                <div className="flex flex-col items-center justify-center py-20 px-6 bg-white border border-gray-200 rounded-lg text-center">
                    ...
                    <p className="text-gray-500 mt-2">
                        Our collection of shrub seeds is currently being prepared. Please check back soon for updates!
                    </p>
                    <Link
