// src/Pages/AllSeasonSeedsPage.jsx
...
export const allSeasonSeedsProducts = [];

const AllSeasonSeedsPage = () => {
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-8 pt-4">
                    <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">
                        All Season Seeds ☀️🌧️❄️
                    </h1>
                    <p className="text-sm text-gray-600">
                        Discover versatile seeds suitable for growing throughout the year, regardless of the season.
                    </p>
                ...
                <div className="flex flex-col items-center justify-center py-20 px-6 bg-white border border-gray-200 rounded-lg text-center">
                    ...
                    <p className="text-gray-500 mt-2">
                        Our collection of all-season seeds is currently being curated. Please check back soon!
                    </p>
                    <Link
                        to="/seeds/season" // Link back to the parent Seeds By Season page
...
export default AllSeasonSeedsPage;