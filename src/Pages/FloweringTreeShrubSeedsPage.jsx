// src/Pages/FloweringTreeShrubSeedsPage.jsx
...
export const floweringTreeShrubProducts = [];

const FloweringTreeShrubSeedsPage = () => {
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-8 pt-4">
                    ...
                    <p className="text-sm text-gray-600">
                        Grow beautiful flowering trees and shrubs to add structure and long-lasting beauty to your landscape.
                    </p>
                ...
                <div className="flex flex-col items-center justify-center py-20 px-6 bg-white border border-gray-200 rounded-lg text-center">
                    ...
                    <p className="text-gray-500 mt-2">
                        Currently, there are no flowering tree or shrub seeds available in this category. Please check back soon!
                    </p>
                    <Link
...
export default FloweringTreeShrubSeedsPage;