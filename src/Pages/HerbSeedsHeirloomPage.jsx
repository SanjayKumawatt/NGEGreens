// src/Pages/HerbSeedsHeirloomPage.jsx
import React from 'react';
import { Link } from 'react-router-dom';
import { AlertCircle, ArrowLeft } from 'lucide-react';
export const herbSeedsHeirloomProducts = []; // Export empty array
const HerbSeedsHeirloomPage = () => {
    const topPaddingClass = "pt-32 md:pt-[150px] lg:pt-[180px]";
    return (
        <div className={`min-h-screen bg-gray-50 ${topPaddingClass}`}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                 <div className="mb-8 pt-4">
                    <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Heirloom Herb Seeds</h1>
                    <p className="text-sm text-gray-600">Discover heritage herb varieties passed down through generations.</p>
                 ...
                 <div className="flex flex-col items-center justify-center py-20 px-6 bg-white border border-gray-200 rounded-lg text-center">
                    ...
                    <p className="text-gray-500 mt-2">Our collection of heirloom herb seeds is coming soon!</p>
...
export default HerbSeedsHeirloomPage;