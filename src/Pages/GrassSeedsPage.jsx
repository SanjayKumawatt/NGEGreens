...
export const grassSeedsProducts = [];

const GrassSeedsPage = () => {
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-8 pt-4">
                    ...
                    <p className="text-sm text-gray-600">
                        Create lush green lawns and pastures with our selection of high-quality grass seeds.
                    </p>
                ...
                <div className="flex flex-col items-center justify-center py-20 px-6 bg-white border border-gray-200 rounded-lg text-center">
                    ...
                    <p className="text-gray-500 mt-2">
                        We are currently preparing our range of grass seeds. Please check back later for availability!
                    </p>
                    <Link
