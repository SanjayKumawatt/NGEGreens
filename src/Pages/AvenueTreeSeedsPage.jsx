// src/Pages/AvenueTreeSeedsPage.jsx
...
export const avenueTreeProducts = [];

const AvenueTreeSeedsPage = () => {
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-8 pt-4">
                    ...
                    <p className="text-sm text-gray-600">
                        Select from seeds suitable for planting along avenues, roadsides, and public spaces, known for their shade and beauty.
                    </p>
                ...
                <div className="flex flex-col items-center justify-center py-20 px-6 bg-white border border-gray-200 rounded-lg text-center">
                    ...
                    <p className="text-gray-500 mt-2">
                        Our selection of avenue tree seeds is currently being prepared. Check back soon for suitable varieties!
                    </p>
                    <Link
...
export default AvenueTreeSeedsPage;