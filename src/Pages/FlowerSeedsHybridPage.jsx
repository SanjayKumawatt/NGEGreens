// src/Pages/FlowerSeedsHybridPage.jsx

import React from 'react';
import { useOutletContext, Link } from 'react-router-dom';
import { AlertCircle } from 'lucide-react'; // Icon for the message

// 👇 STEP 1: Export an empty array (important for ProductDetail.jsx consistency)
export const flowerSeedsHybridProducts = [];

const FlowerSeedsHybridPage = () => {
    // const { onAddToCart } = useOutletContext(); // Not needed as there are no products
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-8 pt-4">
                    ...
                    <p className="text-sm text-gray-600">
                        Explore our collection of hybrid flower seeds known for their unique characteristics and enhanced performance.
                    </p>
...
export default FlowerSeedsHybridPage;